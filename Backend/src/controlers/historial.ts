...
export const obtenerHistorialAcademicoComp = async (req: Request, res: Response) => {
    try {
        let cedula = '';
...
export const obtenerHistorialAcademicoTI = async (req: Request, res: Response) => {
    try {
        let cedula = '';
        if (req.headers.authorization) {
            const token = req.headers.authorization.split(' ')[1];
...
export const obtenerHistorialAcademicoTDE = async (req: Request, res: Response) => {
    try {
        let cedula = '';
        if (req.headers.authorization) {
            const token = req.headers.authorization.split(' ')[1];
...
export const homologacionCompTDE = async (req: Request, res: Response) => {
    let cedula = '';
    if (req.headers.authorization) {
        const token = req.headers.authorization.split(' ')[1];
        try {
...
export const homologacionTIComp = async (req: Request, res: Response) => {
    let cedula = '';
    if (req.headers.authorization) {
        const token = req.headers.authorization.split(' ')[1];
        try {
...
export const homologacionTITDE = async (req: Request, res: Response) => {
    let cedula = '';
    if (req.headers.authorization) {
        const token = req.headers.authorization.split(' ')[1];
        try {
...
export const homologacionTDEComp = async (req: Request, res: Response) => {
    let cedula = '';
    if (req.headers.authorization) {
        const token = req.headers.authorization.split(' ')[1];
        try {
...
export const homologacionTDETI = async (req: Request, res: Response) => {
    let cedula = '';
    if (req.headers.authorization) {
        const token = req.headers.authorization.split(' ')[1];
        try {
...
export const obtenerMallaComp = async (req: Request, res: Response) => {
    let cedula = '';
    if (req.headers.authorization) {
        const token = req.headers.authorization.split(' ')[1];
        try {
...
export const obtenerMallaTDE = async (req: Request, res: Response) => {
    let cedula = '';
    if (req.headers.authorization) {
        const token = req.headers.authorization.split(' ')[1];
        try {
