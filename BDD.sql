...
--
-- Table structure for table `equivalencia_computacion_ti`
--

DROP TABLE IF EXISTS `equivalencia_computacion_ti`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `equivalencia_computacion_ti` (
  `id` int NOT NULL AUTO_INCREMENT,
  `asignaturaOrigenCodigo` varchar(10) NOT NULL,
  `asignaturaDestinoCodigo` varchar(10) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `equivalencia_computacion_ti`
--

LOCK TABLES `equivalencia_computacion_ti` WRITE;
/*!40000 ALTER TABLE `equivalencia_computacion_ti` DISABLE KEYS */;
INSERT INTO `equivalencia_computacion_ti` VALUES (1,'COMP_1075','DSOF_1070'),(2,'MATE_1103','MATE_1103'),(3,'COMP_1078','COMP_1081'),(4,'RELI_1105','RELI_1105'),(5,'MATE_1108','MATE_1108'),(6,'MATE_1101','MATE_1114'),(7,'DSOF_1067','DSOF_1073'),(8,'RELI_2062','RELI_2062'),(9,'DSOF_2030','DSOF_2038'),(10,'COMP_3011','DSOF_2039'),(11,'SIST_3011','SIST_3012'),(12,'DSOF_2034','DSOF_2040'),(13,'DSOF_2029','DSOF_2041'),(14,'FILO_1114','FILO_1114'),(15,'DSOF_3037','DSOF_2043'),(16,'DRBD_2004','DRBD_2006'),(17,'ESTA_3022','ESTA_2029'),(18,'DRBD_4012','DRBD_3019'),(19,'SIST_3011','SIST_3012'),(20,'DRBD_2005','DRBD_3020'),(21,'DSOF_3035','DSOF_3045'),(22,'DSOF_3039','DSOF_3046'),(23,'DSOF_3038','DSOF_3048'),(24,'ADMI_5077','ADMI_4104'),(25,'DRBD_4014','DRBD_4018'),(26,'DSOF_4069','DSOF_4072'),(27,'DSOF_4070','DSOF_4075'),(28,'DSOF_5025','DSOF_4077'),(29,'ADMI_4038','ADMI_4038'),(30,'LITE_1108','UTE_1108');
/*!40000 ALTER TABLE `equivalencia_computacion_ti` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `equivalencia_ti_computacion`
--

DROP TABLE IF EXISTS `equivalencia_ti_computacion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `equivalencia_ti_computacion` (
  `id` int NOT NULL AUTO_INCREMENT,
  `asignaturaOrigenCodigo` varchar(10) NOT NULL,
  `asignaturaDestinoCodigo` varchar(10) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `equivalencia_ti_computacion`
--

LOCK TABLES `equivalencia_ti_computacion` WRITE;
/*!40000 ALTER TABLE `equivalencia_ti_computacion` DISABLE KEYS */;
INSERT INTO `equivalencia_ti_computacion` VALUES (1,'DSOF_1070','COMP_1075'),(2,'MATE_1103','MATE_1103'),(3,'RELI_1105','RELI_1105'),(4,'DSOF_1073','DSOF_1067'),(5,'COMP_1081','COMP_1078'),(6,'DSOF_2038','DSOF_2030'),(7,'MATE_1108','MATE_1108'),(8,'MATE_1114','MATE_1101'),(9,'DSOF_2041','DSOF_2029'),(10,'DSOF_2040','DSOF_2034'),(11,'DRBD_2006','DRBD_2004'),(12,'RELI_2062','RELI_2062'),(13,'DSOF_1071','COMP_2010'),(14,'DSOF_2039','COMP_3011'),(15,'DSOF_2043','DSOF_3037'),(16,'ESTA_2029','ESTA_3022'),(17,'FILO_1114','FILO_1114'),(18,'SIST_3012','SIST_3011'),(19,'DRBD_3019','DRBD_4012'),(20,'DSOF_3046','DSOF_3039'),(21,'DSOF_3045','DSOF_3035'),(22,'DSOF_3048','DSOF_3038'),(23,'DRBD_4018','DRBD_4014'),(24,'DSOF_4072','DSOF_4069'),(25,'ADMI_4038','ADMI_4038'),(26,'DSOF_4075','DSOF_4070'),(27,'UTE_1108','LITE_1108'),(28,'ADMI_4104','ADMI_5077'),(29,'DSOF_4077','DSOF_5025');
/*!40000 ALTER TABLE `equivalencia_ti_computacion` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `estudiantecarrera` (
  ...
  PRIMARY KEY (`idEstudiante`,`idCarrera`),
  KEY `idCarrera` (`idCarrera`),
  CONSTRAINT `estudiantecarrera_ibfk_1` FOREIGN KEY (`idEstudiante`) REFERENCES `estudiantes` (`idEstudiante`),
  CONSTRAINT `estudiantecarrera_ibfk_2` FOREIGN KEY (`idCarrera`) REFERENCES `carreras` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `estudiantecarrera` WRITE;
/*!40000 ALTER TABLE `estudiantecarrera` DISABLE KEYS */;
INSERT INTO `estudiantecarrera` VALUES ('1105589426',1);
...
INSERT INTO `estudiantes` VALUES ('1105589426','Kevin Alexander','Barrazueta Quizhpe','kabarrazueta@utpl.edu.ec','$2b$10$Mg1VskXkPiM9jL7UIMXQRucHPUw4tCEVrzmKjbE3yyMka6.SSCyyO');
...
INSERT INTO `historialacademico` VALUES (1,'1105589426','COMP_1078',9.07,'Aprobada'),(2,'1105589426','DSOF_2030',8.1,'Aprobada'),(3,'1105589426','COMP_1075',8.69,'Aprobada'),(4,'1105589426','MATE_1103',9.22,'Aprobada'),(5,'1105589426','RELI_1105',9.7,'Aprobada'),(6,'1105589426','DSOF_1067',9.27,'Aprobada'),(7,'1105589426','MATE_1108',9.35,'Aprobada'),(8,'1105589426','MATE_1101',9.4,'Aprobada'),(9,'1105589426','DSOF_2029',8.55,'Aprobada'),(10,'1105589426','FISI_1039',8.47,'Aprobada'),(11,'1105589426','DSOF_2034',8.69,'Aprobada'),(12,'1105589426','RELI_2062',8.66,'Aprobada'),(13,'1105589426','MATE_3100',7.65,'Aprobada'),(14,'1105589426','DRBD_2004',8.08,'Aprobada'),(15,'1105589426','ELEN_2008',8.25,'Aprobada'),(16,'1105589426','COMP_2011',8.94,'Aprobada'),(17,'1105589426','DSOF_2035',8.54,'Aprobada'),(18,'1105589426','DSOF_2036',8.2,'Aprobada'),(19,'1105589426','COMP_2010',9.09,'Aprobada'),(20,'1105589426','DRBD_2005',8.01,'Aprobada'),(21,'1105589426','COMP_2012',9.4,'Aprobada'),(22,'1105589426','COMP_4011',8.25,'Aprobada'),(23,'1105589426','DSOF_3036',8.23,'Aprobada'),(24,'1105589426','ESTA_3022',NULL,'Pendiente'),(25,'1105589426','FILO_1114',NULL,